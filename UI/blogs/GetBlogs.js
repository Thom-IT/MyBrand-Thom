...
function htmlOutput(post) {
    ...
    photo.innerHTML = `<div ><a href=./blogs/get1Blog.html?blogId=${post._id} ><img width="600" height="300" src=${post.photoUrl} /></a></div>`;
    postDetails.innerHTML = `<div id="bdy"><p>${post.title}</p>
    <div id="description">${post.description} </div></div>`
