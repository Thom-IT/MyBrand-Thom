...
userDataRef.once("value").then(function(snapshot) {
    snapshot.forEach(function(childSnapshot) {
        ...
        //li.parent('allData')
        $('<div class="fakeimg " style="height: 500px; width: 800px; "><img src="' + photoUrl + '" width="600" height="300"/><h3>' + Title + '</h3><p>' + description + '</p></div><input type="text" name="uidd" id="uidd" value="' + uid + '"></input><button type="submit" id="deleteBtn">Click to Delete</button><br><br></div>').appendTo($('#msgDiv'));
        // $('<input type="text" name="uidd" id="uidd" value="' + uid + '"></input><button type="submit" id="deleteBtn">Click to Delete</button>').appendTo($('#msgDiv'));
